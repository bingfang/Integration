...
$file3LTR="1_KRAS4B_WT_MEF_3LTR_1CGTGAT2TAGCTT.txt";
$file5LTR="1_KRAS4B_WT_MEF_5LTR_1GCCTAA2TAGCTT.txt";
...
################################################
$refgenefile = "/Volumes/legacy/GenomeDatabase/mm10db/mm10_refGene.txt";
