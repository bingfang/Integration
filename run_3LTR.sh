...
/usr/bin/perl _0debarcodingBatchFilter_1read_gz_paired_end_findLTR_linker_new3LTR.pl
/usr/bin/perl _1batch_seqfilter_blat_filter_Spike3LTR.pl
/usr/bin/perl _2batch_count_RIS_Spike3LTR.pl
